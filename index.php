...
<head>
    ...
    <link rel="stylesheet" href="/autoEdge/index.css">
</head>
...
<body>
        ...
        if($_GET['orderPlaced']=='true'){
         echo '
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success!</strong> Your order has been placed successfully. Track your order from <strong><a href="/autoEdge/userProfile.php">here</a>.</strong>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner d-flex justify-content-around" style="background:rgba(0, 0, 0, 0.9);">
        ';
        ...
        while($caraouselRow = mysqli_fetch_assoc($caraouselResult)){
            ...
            <div class="carousel-item active" style="padding: 20px; margin-bottom: 10px">
                <div class="row">
             <div class="col-md-6">
             <a href="/autoEdge/productPage.php?productId='.$carouselId.'">
                    <img class="rounded" src="/autoEdge/uploads/'.$caraouselImg.'" alt="" style="height: 500px; width: 398px;display: block;margin-left: auto;margin-right: auto">
        ...
        echo'
           <div class="col-md-3 mt-2">
                <div class="card" style="height: 500px">
                                    <div class="card-body">
                                        <div class="card">
                                                <a href="/autoEdge/productPage.php?productId='.$id.'"><img src="/autoEdge/uploads/'.$img.'" class="" style="height: 250px; width: 200px"></a>
                                        </div>
                                    </div>
                                    <div class="card-body bg-light text-center">
                                        <div class="mb-2">
                                            <h6 class="font-weight-semibold mb-2">
                                                <a href="/autoEdge/productPage.php?productId='.$id.'" data-abc="true">'.$name.'</a>
                                            </h6>
                                            <a href="/autoEdge/categoryPage.php?cat='.$category.'" class="text-muted" data-abc="true">'.strtoupper($category).'</a>
                                        </div>';
                                        $temp = floor(5-$rating);
                                        for($i=0; $i<$rating; $i++){
                                            echo '<span>⭐</span>';
