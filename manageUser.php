                            ...
                            <div class="table-responsive table-lg mt-3">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>';
                                        ...
                                        echo'
                                        <form action="/autoEdge/utils/_editUser.php" method="post">
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                 <div
                                                    class="bg-light d-inline-flex justify-content-center align-items-center align-top">';
                                                    if($user_type=='admin'){
                                                        echo'<form action="/autoEdge/utils/_removeAdmin.php" method="post">
                                                        <input type="hidden" name="user_id" value="'.$user_id.'">
                                                        <input type="hidden" name="script" value="'.$script.'">
                                                        <input type="hidden" name="params" value="'.$params.'">
                                                        ...
                                                        echo'<form action="/autoEdge/utils/_makeAdmin.php" method="post">
                                                        <input type="hidden" name="user_id" value="'.$user_id.'">
                                                        <input type="hidden" name="script" value="'.$script.'">
                                                        <input type="hidden" name="params" value="'.$params.'">
                                            ...
                                            <td class="text-center align-middle">
                                                ...
                                                <form action="/autoEdge/utils/_deleteUser.php" method = "post">
                                                    <input type="hidden" name="user_id" value="'.$user_id.'">
