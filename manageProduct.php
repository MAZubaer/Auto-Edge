    ...
    if(!isset($_SESSION['user_type'])||$_SESSION['user_type']!='admin'){
        ...
        <div class="container">
            <h1 style= "padding-top: 50px; padding-bottom: 20px;">All Products</h1>
                ...
                <a href="/autoEdge/addProduct.php"><button class="btn btn-success" style= "margin-bottom: 10px">Add new Product <i class="fa fa-plus"></i>
                </button></a>
            ...
            <span class="">#'.$id.'</span>
                ...
                <a class="thumbnail pull-lef" href="#"> <img class="media-object"
                        src="/autoEdge/uploads/'.$image.'"
                        style="width: 72px; height: 72px;"> </a>
                <div class="media-body">
                    <h4 class="media-heading"><a href="/autoEdge/productPage.php?productId='.$id.'">'.$name.'</a></h4>
                </div>
            </div>
        </td>
        ...
        <td class="text-center">
                <form action="/autoEdge/editProduct.php" method = "get">
                        <input type="hidden" name="id" value="'.$id.'">
                        <input type="hidden" name="name" value="'.$name.'">
                        <input type="hidden" name="price" value="'.$price.'">
                        <input type="hidden" name="image" value="/autoEdge/uploads/'.$image.'">
        ...
        <td class="text-center">
                <form action="/autoEdge/utils/_deleteProduct.php" method = "post">
                        <input type="hidden" name="id" value="'.$id.'">
