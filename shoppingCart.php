...
<body>
    ...
    <div class="container">
        <?php
                ...
                <form action="/autoEdge/utils/_clearCart.php" method="post">
                ...
                <div class="media-body">
                    <h4 class="media-heading"><a href="/autoEdge/productPage.php?productId='.$i.'">'.$name.'</a></h4>
        ...
        <form action="/autoEdge/utils/_changeQuantity.php" method="post">
        ...
        echo'
            <form action="/autoEdge/utils/_removeFromCart.php" method="post">
